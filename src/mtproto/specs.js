export const Specs = {
  MTProto: {
    constructors: [{ id: 481674261, predicate: "vector", params: [], type: "Vector t" }, {
      id: 85337187,
      predicate: "resPQ",
      ...
      params: [{ name: "pq", type: "bytes" }, { name: "p", type: "bytes" }, {
        ...
        name: "new_nonce",
        type: "int256"
      }, { name: "dc", type: "int" }, { name: "expires_in", type: "int" }],
      type: "P_Q_inner_data"
    }, {
      id: -790100132,
      ...
      params: [{ name: "nonce", type: "long" }, { name: "temp_auth_key_id", type: "long" }, {
        name: "perm_auth_key_id",
        type: "long"
      }, { name: "temp_session_id", type: "long" }, { name: "expires_at", type: "int" }],
      ...
      id: -601545863,
      predicate: "eitaa_updates_expire_token",
      params: [],
      type: "EitaaUpdatesExpireToken"
    }, {
      id: -1519642063,
      predicate: "eitaa_updates_token",
      params: [{ name: "token", type: "string" }, { name: "expire", type: "int" }, { name: "date", type: "int" }],
      type: "EitaaUpdatesToken"
    }, { id: -601545867, predicate: "eitaa_token_updating", params: [], type: "EitaaTokenUpdating" }, {
      id: -899560710,
      predicate: "adsOpenLinkAction",
      params: [{ name: "link", type: "string" }],
      type: "AdsClickAction"
    }, {
      id: -1661694581,
      predicate: "adsOpenExternalLinkAction",
      params: [{ name: "link", type: "string" }],
      type: "AdsClickAction"
    }, {
      id: 155099767,
      predicate: "adsIntentAction",
      params: [{ name: "uri", type: "string" }],
      type: "AdsClickAction"
    }, {
      id: -545239366,
      predicate: "adsAdPack",
      params: [{ name: "title", type: "string" }, { name: "ads", type: "Vector<AdsAd>" }],
      type: "AdsAdPack"
    }, {
      id: 812057886,
      method: "adsDialogAd",
      params: [{ name: "flags", type: "#" }, { name: "pinnedBackground", type: "flags.2?true" }, {
        name: "muted",
        type: "flags.3?true"
      }, { name: "verified", type: "flags.4?true" }, { name: "expire", type: "int" }, {
        name: "type",
        type: "int"
      }, { name: "id", type: "int" }, { name: "action", type: "AdsClickAction" }, {
        name: "title",
        type: "string"
      }, { name: "badge", type: "string" }, { name: "message", type: "string" }, {
        name: "thumbs",
        type: "Vector<PhotoSize>"
      }, { name: "unreadCount", type: "int" }],
      type: "AdsAd.adsDialogAd"
    }, {
      id: -1205172244,
      method: "adsEmptyAd",
      params: [{ name: "expires", type: "int" }],
      type: "AdsAd.adsEmptyAd"
    }, {
      id: 1635347945,
      predicate: "eitaaAppInfo",
      params: [{ name: "build_version", type: "int" }, {
        name: "device_model",
        type: "string"
      }, { name: "system_version", type: "string" }, { name: "app_version", type: "string" }, {
        name: "lang_code",
        type: "string"
      ...
      params: [{ name: "new_salt", type: "bytes" }, { name: "new_secure_salt", type: "bytes" }, {
        name: "secure_random",
        type: "bytes"
    ...
    methods: [{
      ...
      id: -601545863,
      method: "eitaaUpdatesExpireToken",
      params: [],
      type: "EitaaUpdatesExpireToken"
    }, { id: -601545867, method: "eitaaTokenUpdating", params: [], type: "EitaaTokenUpdating" }]
  }, API: {
    constructors: [{ id: -1132882121, predicate: "boolFalse", params: [], type: "Bool" }, {
      id: -1720552011,
      predicate: "boolTrue",
      params: [],
      type: "Bool"
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "msg_id", type: "int" }, { name: "user_id", type: "long" }],
      type: "InputPeer"
    }, {
      id: -1121318848,
      ...
      params: [{ name: "flags", type: "#" }, { name: "nosound_video", type: "flags.3?true" }, {
        name: "force_file",
        type: "flags.4?true"
      }, { name: "file", type: "InputFile" }, { name: "thumb", type: "flags.2?InputFile" }, {
        name: "mime_type",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, { name: "title", type: "string" }, {
        ...
        name: "payload",
        type: "bytes"
      }, { name: "provider", type: "string" }, { name: "provider_data", type: "DataJSON" }, {
        name: "start_param",
        type: "flags.1?string"
      }],
      type: "InputMedia"
      ...
      params: [{ name: "flags", type: "#" }, { name: "file", type: "flags.0?InputFile" }, {
        name: "video",
      ...
      params: [{ name: "flags", type: "#" }, { name: "lat", type: "double" }, {
        name: "long",
        type: "double"
      ...
      params: [{ name: "flags", type: "#" }, { name: "big", type: "flags.0?true" }, {
        name: "peer",
        type: "InputPeer"
      }, { name: "photo_id", type: "long" }, { name: "volume_id", type: "long" }, { name: "local_id", type: "int" }],
      type: "InputFileLocation"
    }, {
      id: -1652231205,
      predicate: "inputStickerSetThumb",
      params: [{ name: "stickerset", type: "InputStickerSet" }, { name: "thumb_version", type: "int" }],
      type: "InputFileLocation"
    }, {
      id: 93890858,
      predicate: "inputGroupCallStream",
      params: [{ name: "flags", type: "#" }, { name: "call", type: "InputGroupCall" }, {
        name: "time_ms",
        type: "long"
      }, { name: "scale", type: "int" }, { name: "video_channel", type: "flags.0?int" }, {
        name: "video_quality",
        type: "flags.0?int"
      }],
      type: "InputFileLocation"
      ...
      params: [],
      type: "storage.FileType"
    }, { id: -742634630, predicate: "userEmpty", params: [{ name: "id", type: "long" }], type: "User" }, {
      id: 1073147056,
      predicate: "user",
      params: [{ name: "flags", type: "#" }, { name: "self", type: "flags.10?true" }, {
        ...
        name: "min",
        type: "flags.20?true"
      }, { name: "bot_inline_geo", type: "flags.21?true" }, { name: "support", type: "flags.23?true" }, {
        name: "scam",
        type: "flags.24?true"
      }, { name: "apply_min_photo", type: "flags.25?true" }, { name: "fake", type: "flags.26?true" }, {
        name: "id",
        type: "long"
      }, { name: "access_hash", type: "flags.0?long" }, {
        name: "first_name",
        type: "flags.1?string"
      }, { name: "last_name", type: "flags.2?string" }, { name: "username", type: "flags.3?string" }, {
        name: "phone",
        type: "flags.4?string"
      ...
      }, { name: "bot_inline_placeholder", type: "flags.19?string" }, { name: "lang_code", type: "flags.22?string" }],
      type: "User"
    }, { id: 1326562017, predicate: "userProfilePhotoEmpty", params: [], type: "UserProfilePhoto" }, {
      id: 1775479590,
      predicate: "userProfilePhoto",
      params: [{ name: "flags", type: "#" }, { name: "has_video", type: "flags.0?true" }, {
        name: "photo_id",
        type: "long"
      }, { name: "photo_small", type: "FileLocation" }, { name: "photo_big", type: "FileLocation" }, {
        name: "dc_id",
        type: "int"
      }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "creator", type: "flags.0?true" }, {
        ...
        name: "call_active",
        type: "flags.23?true"
      }, { name: "call_not_empty", type: "flags.24?true" }, { name: "id", type: "long" }, {
        name: "title",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, { name: "creator", type: "flags.0?true" }, {
        name: "left",
        type: "flags.2?true"
      }, { name: "broadcast", type: "flags.5?true" }, { name: "verified", type: "flags.7?true" }, {
        name: "megagroup",
        type: "flags.8?true"
      }, { name: "restricted", type: "flags.9?true" }, { name: "signatures", type: "flags.11?true" }, {
        name: "min",
        type: "flags.12?true"
      }, { name: "scam", type: "flags.19?true" }, { name: "has_link", type: "flags.20?true" }, {
        name: "has_geo",
        type: "flags.21?true"
        ...
        name: "fake",
        type: "flags.25?true"
      }, { name: "gigagroup", type: "flags.26?true" }, { name: "id", type: "long" }, {
        name: "access_hash",
        type: "flags.13?long"
        ...
        type: "flags.17?int"
      }, { name: "live_msg_id", type: "flags.29?int" }],
      type: "Chat"
    }, {
      id: 399807445,
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        type: "flags.7?true"
      }, { name: "has_scheduled", type: "flags.8?true" }, { name: "id", type: "long" }, {
        name: "about",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        name: "can_view_stats",
        type: "flags.20?true"
      }, { name: "blocked", type: "flags.22?true" }, { name: "id", type: "long" }, {
        name: "about",
        type: "string"
        ...
        name: "stats_dc",
        type: "flags.12?int"
      }, { name: "pts", type: "int" }, { name: "call", type: "flags.21?InputGroupCall" }, {
        name: "ttl_period",
        type: "flags.24?int"
      ...
      params: [{ name: "user_id", type: "long" }, { name: "inviter_id", type: "long" }, { name: "date", type: "int" }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "chat_id", type: "long" }, {
      ...
      params: [{ name: "flags", type: "#" }, { name: "id", type: "int" }, { name: "peer_id", type: "flags.0?Peer" }],
      type: "Message"
    }, {
      id: -2049520670,
      predicate: "message",
      params: [{ name: "flags", type: "#" }, { name: "out", type: "flags.1?true" }, {
        ...
        name: "legacy",
        type: "flags.19?true"
      }, { name: "edit_hide", type: "flags.21?true" }, { name: "pinned", type: "flags.24?true" }, {
        name: "id",
        type: "int"
      }, { name: "from_id", type: "flags.8?Peer" }, { name: "peer_id", type: "Peer" }, {
        name: "fwd_from",
      ...
      }, { name: "views", type: "flags.10?int" }, { name: "forwards", type: "flags.10?int" }, {
        name: "replies",
      ...
      params: [{ name: "flags", type: "#" }, { name: "out", type: "flags.1?true" }, {
        ...
        name: "from_id",
        type: "flags.8?Peer"
      }, { name: "peer_id", type: "Peer" }, { name: "reply_to", type: "flags.3?MessageReplyHeader" }, {
        name: "date",
        type: "int"
      }, { name: "action", type: "MessageAction" }, { name: "ttl_period", type: "flags.25?int" }],
      type: "Message"
      ...
      params: [{ name: "phone_number", type: "string" }, { name: "first_name", type: "string" }, {
        name: "last_name",
        type: "string"
      }, { name: "vcard", type: "string" }, { name: "user_id", type: "long" }],
      type: "MessageMedia"
      ...
      params: [{ name: "flags", type: "#" }, { name: "geo", type: "GeoPoint" }, {
        name: "heading",
        type: "flags.0?int"
      }, { name: "period", type: "int" }, { name: "proximity_notification_radius", type: "flags.1?int" }],
      type: "MessageMedia"
    }, {
      id: 1272375192,
      ...
      params: [{ name: "from_id", type: "Peer" }, { name: "to_id", type: "Peer" }, { name: "distance", type: "int" }],
      type: "MessageAction"
    }, {
      id: 2047704898,
      ...
      id: 1976012384,
      predicate: "photoSize",
      params: [{ name: "type", type: "string" }, { name: "w", type: "int" }, { name: "h", type: "int" }, {
        name: "size",
        type: "int"
      }],
      type: "PhotoSize"
      ...
      params: [{ name: "type", type: "string" }, { name: "w", type: "int" }, {
        name: "h",
        type: "int"
      ...
      id: -1297942941,
      predicate: "geoPoint",
      params: [{ name: "flags", type: "#" }, { name: "long", type: "double" }, {
        name: "lat",
        type: "double"
      }, { name: "access_hash", type: "long" }, { name: "accuracy_radius", type: "flags.0?int" }],
      type: "GeoPoint"
    }, {
      id: 541710092,
      predicate: "geoPoint_84",
      params: [{ name: "long", type: "double" }, { name: "lat", type: "double" }],
      type: "GeoPoint"
    }, {
      id: 1577067778,
      predicate: "auth.sentCode",
      params: [{ name: "flags", type: "#" }, { name: "type", type: "auth.SentCodeType" }, {
        name: "phone_code_hash",
        type: "string"
      }, { name: "next_type", type: "flags.1?auth.CodeType" }, { name: "timeout", type: "flags.2?int" }],
      type: "auth.SentCode"
    }, {
      id: -855308010,
      predicate: "auth.authorization",
      params: [{ name: "flags", type: "#" }, { name: "token", type: "string" }, { name: "user", type: "User" }],
      ...
      params: [{ name: "id", type: "long" }, { name: "flags", type: "#" }, {
        name: "default",
        type: "flags.1?true"
      }, { name: "dark", type: "flags.4?true" }, { name: "settings", type: "flags.2?WallPaperSettings" }],
      type: "WallPaper"
      ...
      params: [],
      type: "ReportReason"
    }, { id: -1041980751, predicate: "inputReportReasonOther", params: [], type: "ReportReason" }, {
      id: -1685456582,
      ...
      params: [],
      type: "ReportReason"
    }, { id: -170010905, predicate: "inputReportReasonFake", params: [], type: "ReportReason" }, {
      id: -694681851,
      predicate: "userFull",
      ...
      params: [{ name: "blocked", type: "Vector<PeerBlocked>" }, {
        name: "chats",
        type: "Vector<Chat>"
      ...
      params: [{ name: "count", type: "int" }, { name: "blocked", type: "Vector<PeerBlocked>" }, {
        name: "chats",
        type: "Vector<Chat>"
      }, { name: "users", type: "Vector<User>" }],
      type: "contacts.Blocked"
      ...
      params: [{ name: "flags", type: "#" }, { name: "inexact", type: "flags.1?true" }, {
        name: "pts",
        type: "int"
      }, { name: "count", type: "int" }, { name: "offset_id_offset", type: "flags.2?int" }, {
        name: "messages",
        type: "Vector<Message>"
      }, { name: "chats", type: "Vector<Chat>" }, { name: "users", type: "Vector<User>" }],
      type: "messages.Messages"
      ...
      params: [],
      type: "MessagesFilter"
    }, { id: 464520273, predicate: "inputMessagesFilterPinned", params: [], type: "MessagesFilter" }, {
      id: 522914557,
      ...
      params: [{ name: "chat_id", type: "long" }, { name: "from_id", type: "Peer" }, {
        name: "action",
      ...
      params: [{ name: "user_id", type: "long" }, { name: "first_name", type: "string" }, {
        name: "last_name",
        type: "string"
      ...
      params: [{ name: "chat_id", type: "long" }, { name: "user_id", type: "long" }, {
        name: "inviter_id",
        type: "long"
      ...
      params: [{ name: "chat_id", type: "long" }, { name: "user_id", type: "long" }, { name: "version", type: "int" }],
      type: "Update"
    }, {
      id: -1906403213,
      ...
      params: [{ name: "flags", type: "#" }, { name: "channel_id", type: "long" }, {
        name: "pts",
        type: "flags.0?int"
      }],
      type: "Update"
      ...
      params: [{ name: "flags", type: "#" }, { name: "folder_id", type: "flags.0?int" }, {
        name: "channel_id",
        type: "long"
      }, { name: "max_id", type: "int" }, { name: "still_unread_count", type: "int" }, { name: "pts", type: "int" }],
      type: "Update"
    }, {
      id: -1020437742,
      predicate: "updateDeleteChannelMessages",
      params: [{ name: "channel_id", type: "long" }, { name: "messages", type: "Vector<int>" }, {
        name: "pts",
        type: "int"
      }, { name: "pts_count", type: "int" }],
      type: "Update"
      ...
      params: [{ name: "channel_id", type: "long" }, { name: "id", type: "int" }, { name: "views", type: "int" }],
      type: "Update"
    }, {
      id: -674602590,
      ...
      params: [{ name: "flags", type: "#" }, { name: "user_id", type: "long" }, {
        name: "query",
        type: "string"
      ...
      params: [{ name: "channel_id", type: "long" }, { name: "webpage", type: "WebPage" }, {
        name: "pts",
        type: "int"
      }, { name: "pts_count", type: "int" }],
      type: "Update"
      ...
      params: [{ name: "query_id", type: "long" }, { name: "user_id", type: "long" }, {
        name: "payload",
        type: "bytes"
      ...
      params: [{ name: "folder_peers", type: "Vector<FolderPeer>" }, { name: "pts", type: "int" }, {
        name: "pts_count",
        type: "int"
      }],
      type: "Update"
      ...
      params: [{ name: "poll_id", type: "long" }, { name: "user_id", type: "long" }, {
        name: "options",
        type: "Vector<bytes>"
      }, { name: "qts", type: "int" }],
      type: "Update"
      ...
      params: [{ name: "channel_id", type: "long" }, { name: "id", type: "int" }, { name: "forwards", type: "int" }],
      type: "Update"
    }, {
      id: -693004986,
      ...
      params: [{ name: "flags", type: "#" }, { name: "channel_id", type: "long" }, {
        name: "top_msg_id",
        type: "int"
      }, { name: "read_max_id", type: "int" }, { name: "broadcast_id", type: "flags.0?long" }, {
        name: "broadcast_post",
        type: "flags.0?int"
      }],
      type: "Update"
      ...
      params: [{ name: "channel_id", type: "long" }, { name: "top_msg_id", type: "int" }, {
        name: "read_max_id",
        type: "int"
      }],
      type: "Update"
      ...
      params: [{ name: "peer_id", type: "Peer" }, { name: "blocked", type: "Bool" }],
      type: "Update"
    }, {
      id: -1937192669,
      ...
      params: [{ name: "flags", type: "#" }, { name: "channel_id", type: "long" }, {
        name: "top_msg_id",
        type: "flags.0?int"
      }, { name: "from_id", type: "Peer" }, { name: "action", type: "SendMessageAction" }],
      type: "Update"
    }, {
      id: -309990731,
      ...
      params: [{ name: "flags", type: "#" }, { name: "pinned", type: "flags.0?true" }, {
        name: "peer",
        type: "Peer"
      }, { name: "messages", type: "Vector<int>" }, { name: "pts", type: "int" }, { name: "pts_count", type: "int" }],
      type: "Update"
    }, {
      id: 1538885128,
      ...
      params: [{ name: "chat_id", type: "long" }, { name: "call", type: "GroupCall" }],
      type: "Update"
    }, {
      id: -1147422299,
      predicate: "updatePeerHistoryTTL",
      params: [{ name: "flags", type: "#" }, { name: "peer", type: "Peer" }, {
        name: "ttl_period",
        type: "flags.0?int"
      }],
      type: "Update"
      ...
      params: [{ name: "flags", type: "#" }, { name: "chat_id", type: "long" }, {
        name: "date",
        type: "int"
      }, { name: "actor_id", type: "long" }, { name: "user_id", type: "long" }, {
      ...
      params: [{ name: "flags", type: "#" }, { name: "presentation", type: "flags.0?true" }, {
        name: "params",
        type: "DataJSON"
      }],
      type: "Update"
      ...
      params: [{ name: "peer", type: "Peer" }, { name: "bot_id", type: "long" }, {
        name: "commands",
      ...
      params: [{ name: "flags", type: "#" }, { name: "out", type: "flags.1?true" }, {
        ...
        name: "id",
        type: "int"
      }, { name: "user_id", type: "long" }, { name: "message", type: "string" }, {
        name: "pts",
        type: "int"
        ...
        name: "reply_to",
        type: "flags.3?MessageReplyHeader"
      }, { name: "entities", type: "flags.7?Vector<MessageEntity>" }, { name: "ttl_period", type: "flags.25?int" }],
      type: "Updates"
    }, {
      id: 1299050149,
      ...
      params: [{ name: "flags", type: "#" }, { name: "out", type: "flags.1?true" }, {
        ...
        name: "id",
        type: "int"
      }, { name: "from_id", type: "long" }, { name: "chat_id", type: "long" }, {
        name: "message",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        type: "flags.6?true"
      }, { name: "blocked_mode", type: "flags.8?true" }, { name: "pfs_enabled", type: "flags.13?true" }, {
        name: "date",
        type: "int"
        ...
        name: "schedule_period_foreground_ms",
        type: "int"
      }, { name: "schedule_period_background_ms", type: "int" }, {
        name: "schedule_period_background_delay_ms",
        type: "int"
      }, { name: "upload_chunk_size_kb", type: "int" }, { name: "download_chunk_size_kb", type: "int" }],
      type: "Config"
    }, {
      id: -1910892683,
      predicate: "nearestDc",
      ...
      params: [{ name: "id", type: "int" }, { name: "access_hash", type: "long" }, {
        name: "date",
        type: "int"
      }, { name: "admin_id", type: "long" }, { name: "participant_id", type: "long" }],
      type: "EncryptedChat"
    }, {
      id: 1223809356,
      ...
      params: [{ name: "flags", type: "#" }, { name: "folder_id", type: "flags.0?int" }, {
        ...
        name: "admin_id",
        type: "long"
      }, { name: "participant_id", type: "long" }, { name: "g_a", type: "bytes" }],
      type: "EncryptedChat"
    }, {
      id: 1643173063,
      ...
      params: [{ name: "flags", type: "#" }, { name: "history_deleted", type: "flags.0?true" }, {
        name: "id",
        type: "int"
      }],
      type: "EncryptedChat"
      ...
      params: [{ name: "flags", type: "#" }, { name: "id", type: "long" }, {
        ...
        name: "video_thumbs",
        type: "flags.1?Vector<VideoSize>"
      }, { name: "dc_id", type: "int" }, { name: "attributes", type: "Vector<DocumentAttribute>" }],
      type: "Document"
    }, {
      id: 398898678,
      ...
      params: [{ name: "emoticon", type: "string" }, { name: "interaction", type: "DataJSON" }],
      type: "SendMessageAction"
    }, {
      id: -1234857938,
      ...
      params: [{ name: "my_results", type: "Vector<Peer>" }, { name: "results", type: "Vector<Peer>" }, {
        name: "chats",
        type: "Vector<Chat>"
      }, { name: "users", type: "Vector<User>" }],
      type: "contacts.Found"
      ...
      params: [{ name: "rules", type: "Vector<PrivacyRule>" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        name: "current_salt",
        type: "bytes"
      }, { name: "new_salt", type: "bytes" }, { name: "new_secure_salt", type: "bytes" }, {
        name: "secure_random",
        type: "bytes"
      }, { name: "hint", type: "string" }, { name: "email_unconfirmed_pattern", type: "string" }],
      type: "account.Password2"
    }, {
      id: -1705233435,
      ...
      id: 570402317,
      predicate: "account.passwordInputSettingsLayer68",
      params: [{ name: "flags", type: "#" }, { name: "new_salt", type: "flags.0?bytes" }, {
        ...
        name: "new_secure_salt",
        type: "flags.2?bytes"
      }, { name: "new_secure_secret", type: "flags.2?bytes" }, { name: "new_secure_secret_id", type: "flags.2?long" }],
      type: "account.PasswordInputSettings"
    }, {
      id: 326715557,
      ...
      params: [{ name: "flags", type: "#" }, { name: "revoked", type: "flags.0?true" }, {
        name: "permanent",
        type: "flags.5?true"
      }, { name: "link", type: "string" }, { name: "admin_id", type: "long" }, {
        name: "date",
        type: "int"
      }, { name: "start_date", type: "flags.4?int" }, {
        name: "expire_date",
        type: "flags.1?int"
      }, { name: "usage_limit", type: "flags.2?int" }, { name: "usage", type: "flags.3?int" }],
      type: "ExportedChatInvite"
    }, {
      id: -64092740,
      predicate: "chatInviteExportedLayer122",
      params: [{ name: "link", type: "string" }],
      type: "ExportedChatInvite"
    }, {
      id: 1776236393,
      predicate: "chatInviteEmptyLayer122",
      params: [],
      type: "ExportedChatInvite"
    }, {
      id: 1516793212,
      ...
      params: [{ name: "flags", type: "#" }, { name: "archived", type: "flags.1?true" }, {
        name: "official",
        type: "flags.2?true"
      }, { name: "masks", type: "flags.3?true" }, { name: "animated", type: "flags.5?true" }, {
        name: "installed_date",
        type: "flags.0?int"
      }, { name: "id", type: "long" }, { name: "access_hash", type: "long" }, {
        name: "title",
      ...
      }, { name: "thumb_dc_id", type: "flags.4?int" }, { name: "thumb_version", type: "flags.4?int" }, {
        name: "count",
        type: "int"
      }, { name: "hash", type: "int" }],
      type: "StickerSet"
      ...
      id: 460632885,
      predicate: "botInfo",
      params: [{ name: "user_id", type: "long" }, { name: "description", type: "string" }, {
        name: "commands",
        type: "Vector<BotCommand>"
      }],
      type: "BotInfo"
      ...
      params: [{ name: "flags", type: "#" }, { name: "requires_password", type: "flags.0?true" }, {
        name: "text",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, { name: "request_write_access", type: "flags.0?true" }, {
        name: "text",
        type: "string"
      }, { name: "fwd_text", type: "flags.1?string" }, { name: "url", type: "string" }, {
        name: "bot",
        type: "InputUser"
      }],
      type: "KeyboardButton"
      ...
      params: [{ name: "flags", type: "#" }, { name: "quiz", type: "flags.0?Bool" }, { name: "text", type: "string" }],
      type: "KeyboardButton"
    }, {
      id: 2002815875,
      ...
      params: [{ name: "offset", type: "int" }, { name: "length", type: "int" }, { name: "user_id", type: "long" }],
      type: "MessageEntity"
    }, {
      id: 546203849,
      ...
      params: [{ name: "flags", type: "#" }, { name: "can_edit", type: "flags.0?true" }, {
        name: "self",
        type: "flags.1?true"
      }, { name: "user_id", type: "long" }, { name: "inviter_id", type: "flags.1?long" }, {
        name: "promoted_by",
        type: "long"
      ...
      params: [{ name: "flags", type: "#" }, { name: "left", type: "flags.0?true" }, {
        name: "peer",
        type: "Peer"
      }, { name: "kicked_by", type: "long" }, { name: "date", type: "int" }, {
        name: "banned_rights",
        type: "ChatBannedRights"
      }],
      type: "ChannelParticipant"
      ...
      params: [{ name: "flags", type: "#" }, { name: "q", type: "flags.0?string" }, {
        name: "top_msg_id",
        type: "flags.1?int"
      }],
      type: "ChannelParticipantsFilter"
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        name: "description",
        type: "string"
      }, { name: "photo", type: "flags.0?WebDocument" }, { name: "currency", type: "string" }, {
        name: "total_amount",
        type: "long"
      }, { name: "reply_markup", type: "flags.2?ReplyMarkup" }],
      type: "BotInlineMessage"
      ...
      params: [{ name: "flags", type: "#" }, { name: "imported", type: "flags.7?true" }, {
        name: "from_id",
        type: "flags.0?Peer"
      }, { name: "from_name", type: "flags.5?string" }, { name: "date", type: "int" }, {
        name: "channel_post",
        type: "flags.2?int"
      ...
      params: [{ name: "dc_id", type: "int" }, { name: "owner_id", type: "long" }, {
        name: "id",
        type: "int"
      ...
      params: [{ name: "hash", type: "long" }, { name: "count", type: "int" }, {
        name: "sets",
      ...
      params: [{ name: "hash", type: "long" }, { name: "packs", type: "Vector<StickerPack>" }, {
        name: "stickers",
        type: "Vector<Document>"
      ...
      id: 1940093419,
      predicate: "highScore",
      params: [{ name: "pos", type: "int" }, { name: "user_id", type: "long" }, { name: "score", type: "int" }],
      type: "HighScore"
    }, {
      id: -1707344487,
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        type: "flags.2?true"
      }, { name: "password_missing", type: "flags.3?true" }, { name: "form_id", type: "long" }, {
        name: "bot_id",
        type: "long"
      }, { name: "invoice", type: "Invoice" }, { name: "provider_id", type: "long" }, {
        name: "url",
        type: "string"
      ...
      params: [{ name: "flags", type: "#" }, { name: "date", type: "int" }, {
        name: "bot_id",
        type: "long"
      }, { name: "provider_id", type: "long" }, { name: "title", type: "string" }, {
        name: "description",
        type: "string"
      }, { name: "photo", type: "flags.2?WebDocument" }, { name: "invoice", type: "Invoice" }, {
        name: "info",
        type: "flags.0?PaymentRequestedInfo"
      ...
      params: [{ name: "flags", type: "#" }, { name: "video", type: "flags.6?true" }, {
        ...
        name: "admin_id",
        type: "long"
      }, { name: "participant_id", type: "long" }, { name: "g_a_hash", type: "bytes" }, {
        name: "protocol",
        type: "PhoneCallProtocol"
      }],
      type: "PhoneCall"
      ...
      params: [{ name: "flags", type: "#" }, { name: "video", type: "flags.6?true" }, {
        ...
        name: "admin_id",
        type: "long"
      }, { name: "participant_id", type: "long" }, { name: "g_b", type: "bytes" }, {
        name: "protocol",
        type: "PhoneCallProtocol"
      }],
      type: "PhoneCall"
      ...
      params: [{ name: "flags", type: "#" }, { name: "need_rating", type: "flags.2?true" }, {
        name: "need_debug",
        type: "flags.3?true"
      }, { name: "video", type: "flags.6?true" }, { name: "id", type: "long" }, {
        name: "reason",
      ...
      params: [{ name: "flags", type: "#" }, { name: "turn", type: "flags.0?true" }, {
        name: "stun",
        type: "flags.1?true"
      }, { name: "id", type: "long" }, { name: "ip", type: "string" }, { name: "ipv6", type: "string" }, {
        name: "port",
        type: "int"
      ...
      params: [{ name: "prev_invite", type: "ExportedChatInvite" }, { name: "new_invite", type: "ExportedChatInvite" }],
      type: "ChannelAdminLogEventAction"
    }, {
      id: 1048537159,
      ...
      id: -26672755,
      predicate: "channelAdminLogEventActionChangeTheme",
      params: [{ name: "prev_value", type: "string" }, { name: "new_value", type: "string" }],
      type: "ChannelAdminLogEventAction"
    }, {
      id: 531458253,
      ...
      params: [{ name: "flags", type: "#" }, { name: "join", type: "flags.0?true" }, {
        ...
        name: "delete",
        type: "flags.13?true"
      }, { name: "group_call", type: "flags.14?true" }, { name: "invites", type: "flags.15?true" }],
      ...
      params: [{ name: "urls", type: "Vector<RecentMeUrl>" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "hash", type: "long" }, { name: "bot_id", type: "long" }, {
        name: "domain",
        type: "string"
      ...
      params: [{ name: "authorizations", type: "Vector<WebAuthorization>" }, { name: "users", type: "Vector<User>" }],
      ...
      params: [{ name: "type", type: "SecureValueType" }, { name: "file_hash", type: "Vector<bytes>" }, {
        name: "text",
        type: "string"
      }],
      type: "SecureValueError"
      ...
      params: [{ name: "data", type: "bytes" }, { name: "hash", type: "bytes" }, { name: "secret", type: "bytes" }],
      type: "SecureCredentialsEncrypted"
    }, {
      id: -1389486888,
      ...
      params: [{ name: "flags", type: "#" }, { name: "native_names", type: "flags.0?true" }, {
        name: "selfie_required",
        type: "flags.1?true"
      }, { name: "translation_required", type: "flags.2?true" }, { name: "type", type: "SecureValueType" }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "header", type: "flags.0?true" }, {
        ...
        name: "valign_middle",
        type: "flags.5?true"
      }, { name: "valign_bottom", type: "flags.6?true" }, { name: "text", type: "flags.7?RichText" }, {
        name: "colspan",
        type: "flags.1?int"
      ...
      params: [{ name: "flags", type: "#" }, { name: "url", type: "string" }, {
        name: "webpage_id",
        type: "long"
      }, { name: "title", type: "flags.0?string" }, { name: "description", type: "flags.1?string" }, {
        name: "photo_id",
        type: "flags.2?long"
      }, { name: "author", type: "flags.3?string" }, { name: "published_date", type: "flags.4?int" }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "change_info", type: "flags.0?true" }, {
        ...
        name: "add_admins",
        type: "flags.9?true"
      }, { name: "anonymous", type: "flags.10?true" }, { name: "manage_call", type: "flags.11?true" }, {
        name: "other",
        type: "flags.12?true"
      }],
      type: "ChatAdminRights"
      ...
      params: [{ name: "flags", type: "#" }, { name: "disabled", type: "flags.0?true" }, {
        name: "video_preload_large",
        type: "flags.1?true"
      }, { name: "audio_preload_next", type: "flags.2?true" }, {
        name: "phonecalls_less_data",
        type: "flags.3?true"
      }, { name: "photo_size_max", type: "int" }, { name: "video_size_max", type: "int" }, {
        name: "file_size_max",
        type: "int"
      ...
      params: [{ name: "flags", type: "#" }, {
        ...
        type: "flags.2?true"
      }, { name: "id", type: "int" }, { name: "title", type: "string" }, { name: "photo", type: "flags.3?ChatPhoto" }],
      type: "Folder"
    }, {
      id: -70073706,
      ...
      params: [{ name: "peer", type: "Peer" }, { name: "expires", type: "int" }, { name: "distance", type: "int" }],
      type: "PeerLocated"
    }, {
      id: -118740917,
      ...
      params: [{ name: "flags", type: "#" }, { name: "creator", type: "flags.0?true" }, {
        name: "default",
        type: "flags.1?true"
      }, { name: "for_chat", type: "flags.5?true" }, { name: "id", type: "long" }, {
        name: "access_hash",
        type: "long"
      }, { name: "slug", type: "string" }, { name: "title", type: "string" }, {
        name: "document",
        type: "flags.2?Document"
      }, { name: "settings", type: "flags.3?ThemeSettings" }, { name: "installs_count", type: "flags.4?int" }],
      type: "Theme"
    }, {
      id: -199313886,
      ...
      params: [{ name: "dates", type: "Vector<int>" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "user_id", type: "long" }, { name: "option", type: "bytes" }, { name: "date", type: "int" }],
      ...
      params: [{ name: "user_id", type: "long" }, { name: "options", type: "Vector<bytes>" }, {
        name: "date",
        type: "int"
      }],
      type: "MessageUserVote"
      ...
      params: [{ name: "flags", type: "#" }, { name: "contacts", type: "flags.0?true" }, {
        name: "non_contacts",
        type: "flags.1?true"
      }, { name: "groups", type: "flags.2?true" }, { name: "broadcasts", type: "flags.3?true" }, {
        name: "bots",
        type: "flags.4?true"
      ...
      }, { name: "include_peers", type: "Vector<InputPeer>" }, { name: "exclude_peers", type: "Vector<InputPeer>" }],
      type: "DialogFilter"
    }, {
      id: 2004110666,
      ...
      params: [{ name: "msg_id", type: "int" }, { name: "views", type: "int" }, { name: "forwards", type: "int" }],
      ...
      id: -567037804,
      predicate: "videoSize",
      params: [{ name: "flags", type: "#" }, { name: "type", type: "string" }, { name: "w", type: "int" }, {
        name: "h",
        type: "int"
      }, { name: "size", type: "int" }, { name: "video_start_ts", type: "flags.0?double" }],
      type: "VideoSize"
    }, {
      id: -1660637285,
      predicate: "statsGroupTopPoster",
      params: [{ name: "user_id", type: "long" }, { name: "messages", type: "int" }, {
        name: "avg_chars",
        type: "int"
      }],
      ...
      params: [{ name: "user_id", type: "long" }, { name: "deleted", type: "int" }, {
        name: "kicked",
        type: "int"
      ...
      params: [{ name: "flags", type: "#" }, { name: "archive_and_mute_new_noncontact_peers", type: "flags.0?Bool" }],
      type: "GlobalPrivacySettings"
    }, {
      id: 1107543535,
      predicate: "help.countryCode",
      params: [{ name: "flags", type: "#" }, { name: "country_code", type: "string" }, {
        name: "prefixes",
      ...
      params: [{ name: "flags", type: "#" }, { name: "hidden", type: "flags.0?true" }, {
        name: "iso2",
        type: "string"
      }, { name: "default_name", type: "string" }, { name: "name", type: "flags.1?string" }, {
        name: "country_codes",
      ...
      params: [{ name: "flags", type: "#" }, { name: "views", type: "flags.0?int" }, {
        name: "forwards",
        type: "flags.1?int"
      ...
      params: [{ name: "views", type: "Vector<MessageViews>" }, {
        name: "chats",
        type: "Vector<Chat>"
      }, { name: "users", type: "Vector<User>" }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "messages", type: "Vector<Message>" }, {
        name: "max_id",
        type: "flags.0?int"
      }, { name: "read_inbox_max_id", type: "flags.1?int" }, {
        name: "read_outbox_max_id",
        type: "flags.2?int"
      }, { name: "unread_count", type: "int" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "reply_to_msg_id", type: "int" }, {
      ...
      params: [{ name: "flags", type: "#" }, { name: "comments", type: "flags.0?true" }, {
        name: "replies",
        type: "int"
      }, { name: "replies_pts", type: "int" }, {
        name: "recent_repliers",
        type: "flags.1?Vector<Peer>"
      }, { name: "channel_id", type: "flags.0?long" }, { name: "max_id", type: "flags.2?int" }, {
        name: "read_max_id",
        type: "flags.3?int"
      }],
      type: "MessageReplies"
      ...
      params: [{ name: "id", type: "long" }, { name: "access_hash", type: "long" }, { name: "duration", type: "int" }],
      type: "GroupCall"
    }, {
      id: -711498484,
      predicate: "groupCall",
      params: [{ name: "flags", type: "#" }, {
        ...
        type: "flags.9?true"
      }, { name: "record_video_active", type: "flags.11?true" }, { name: "id", type: "long" }, {
        name: "access_hash",
        type: "long"
      }, { name: "participants_count", type: "int" }, { name: "title", type: "flags.3?string" }, {
        name: "stream_dc_id",
        type: "flags.4?int"
      ...
      params: [{ name: "flags", type: "#" }, { name: "muted", type: "flags.0?true" }, {
        name: "left",
        type: "flags.1?true"
      }, { name: "can_self_unmute", type: "flags.2?true" }, {
        name: "just_joined",
        type: "flags.4?true"
      }, { name: "versioned", type: "flags.5?true" }, { name: "min", type: "flags.8?true" }, {
        name: "muted_by_you",
        type: "flags.9?true"
      }, { name: "volume_by_admin", type: "flags.10?true" }, {
        name: "self",
        type: "flags.12?true"
      }, { name: "video_joined", type: "flags.15?true" }, { name: "peer", type: "Peer" }, {
        name: "date",
        type: "int"
      }, { name: "active_date", type: "flags.3?int" }, { name: "source", type: "int" }, {
        name: "volume",
        type: "flags.7?int"
      ...
      params: [{ name: "call", type: "GroupCall" }, {
        name: "participants",
        type: "Vector<GroupCallParticipant>"
      }, { name: "participants_next_offset", type: "string" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "count", type: "int" }, {
        name: "participants",
        type: "Vector<GroupCallParticipant>"
      }, { name: "next_offset", type: "string" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }, { name: "version", type: "int" }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "pm", type: "flags.0?true" }, {
        name: "group",
        type: "flags.1?true"
      ...
      params: [{ name: "count", type: "int" }, { name: "invites", type: "Vector<ExportedChatInvite>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "invite", type: "ExportedChatInvite" }, { name: "users", type: "Vector<User>" }],
      ...
      params: [{ name: "admin_id", type: "long" }, {
        name: "invites_count",
        type: "int"
      ...
      params: [{ name: "admins", type: "Vector<ChatAdminWithInvites>" }, { name: "users", type: "Vector<User>" }],
      ...
      params: [{ name: "peers", type: "Vector<Peer>" }, { name: "chats", type: "Vector<Chat>" }, {
        name: "users",
        type: "Vector<User>"
      }],
      ...
      params: [{ name: "flags", type: "#" }, { name: "paused", type: "flags.0?true" }, {
        name: "endpoint",
        type: "string"
    ...
    }, { id: 795652779, predicate: "botCommandScopeDefault", params: [], type: "BotCommandScope" }, {
      id: 1011811544,
      predicate: "botCommandScopeUsers",
      params: [],
      type: "BotCommandScope"
    }, { id: 1877059713, predicate: "botCommandScopeChats", params: [], type: "BotCommandScope" }, {
      id: -1180016534,
      ...
      id: -318022605,
      predicate: "chatTheme",
      params: [{ name: "emoticon", type: "string" }, { name: "theme", type: "Theme" }, {
        name: "dark_theme",
        type: "Theme"
      }],
      type: "ChatTheme"
      ...
      params: [{ name: "flags", type: "#" }, { name: "random_id", type: "bytes" }, {
        name: "from_id",
        type: "Peer"
      }, { name: "start_param", type: "flags.0?string" }, { name: "message", type: "string" }, {
        name: "entities",
        type: "flags.1?Vector<MessageEntity>"
      }],
      ...
      params: [{ name: "messages", type: "Vector<SponsoredMessage>" }, {
        name: "chats",
        type: "Vector<Chat>"
      }, { name: "users", type: "Vector<User>" }],
      ...
      id: 1640969877,
      predicate: "liveGetMedia",
      params: [{ name: "flags", type: "int" }, { name: "id", type: "long" }, { name: "access_hash", type: "long" }],
      type: "LiveGetMedia"
    }, {
      id: 1632839530,
      predicate: "chatPhoto",
      ...
      id: -873187034,
      predicate: "messageMediaLiveStream",
      params: [{ name: "flags", type: "#" }, { name: "from_self", type: "flags.1?true" }, {
        name: "id",
        type: "long"
      }, { name: "access_hash", type: "long" }, { name: "total_viewers", type: "flags.0?int" }, {
        name: "state",
        type: "LiveStreamState"
      }, { name: "thumbs", type: "flags.2?Vector<PhotoSize>" }],
      type: "MessageMedia"
    }, { id: -1263446626, predicate: "liveStreamStateInit", params: [], type: "LiveStreamState" }, {
      id: -1151640075,
      predicate: "liveStreamStateBroadcasting",
      params: [{ name: "flags", type: "#" }, { name: "paused", type: "flags.0?true" }, {
        name: "liveStream",
        type: "LiveStream"
      }],
      ...
      id: -1202907733,
      predicate: "liveStreamStateEnded",
      params: [{ name: "flags", type: "#" }, { name: "duration", type: "int" }, {
        name: "expire_date",
        type: "flags.0?int"
      }, { name: "archive_link", type: "flags.0?string" }],
      type: "LiveStreamState"
    }, {
      id: -53427794,
      predicate: "liveStreamStateEnded2",
      params: [{ name: "flags", type: "#" }, { name: "duration", type: "int" }, {
        name: "expire_date",
        type: "flags.0?int"
      }, { name: "archive_link", type: "flags.0?string" }, { name: "archive_size", type: "flags.0?int" }],
      type: "LiveStreamState"
    }, {
      id: 765942443,
      predicate: "liveStream",
      params: [{ name: "flags", type: "#" }, { name: "read_link", type: "flags.0?string" }, {
        name: "write_link",
        type: "flags.1?string"
      ...
      id: -2008309847,
      predicate: "liveGetParticipants",
      params: [{ name: "id", type: "long" }, { name: "access_hash", type: "long" }],
      type: "LiveGetParticipants"
    }, {
      id: -219577344,
      predicate: "liveParticipants",
      params: [{ name: "users", type: "Vector<User>" }],
      type: "LiveParticipants"
    }, {
      id: -1829372741,
      predicate: "adsInputAdsLocationRecommend",
      params: [],
      type: "AdsLocation"
    }, {
      id: -338836925,
      predicate: "adsInputAdsLocationChatMembers",
      params: [{ name: "peer", type: "InputPeer" }],
      type: "AdsLocation"
    }, { id: -415214013, predicate: "adsInputAdsLocationContacts", params: [], type: "AdsLocation" }, {
      id: 1557811792,
      predicate: "adsInputAdsLocationTrends",
      params: [{ name: "groupTitle", type: "string" }],
      type: "AdsLocation"
    }, { id: 314488883, predicate: "adsInputAdsLocationDialog", params: [], type: "AdsLocation" }, {
      id: -1626620176,
      predicate: "statAd",
      params: [{ name: "id", type: "int" }, { name: "adsLocation", type: "AdsLocation" }],
      type: "StatAd"
    }, {
      id: 1635347945,
      predicate: "eitaaAppInfo",
    ...
    methods: [{
      ...
      params: [{ name: "phone_number", type: "string" }, {
        ...
        name: "last_name",
        type: "string"
      }, { name: "app_info", type: "EitaaAppInfo" }],
      type: "auth.Authorization"
    }, {
      id: -1126886015,
      method: "auth.signIn",
      ...
      id: -1987323361,
      method: "auth.checkPassword2",
      params: [{ name: "password_hash", type: "bytes" }, { name: "flags", type: "#" }, {
        name: "phone_code",
        type: "flags.0?string"
      }, { name: "phone_number", type: "flags.1?string" }],
      type: "auth.Authorization"
    }, {
      id: -661144474,
      ...
      params: [{ name: "flags", type: "#" }, { name: "code", type: "string" }, {
        name: "new_settings",
      ...
      id: 3612004724,
      method: "account.getPasswordLayer68",
      params: [{ name: "flags", type: "#" }, { name: "phone_code", type: "flags.0?string" }, {
        name: "phone_number",
        type: "flags.1?string"
      }],
      type: "account.Password"
      ...
      id: -92517498,
      method: "account.updatePasswordSettingsLayer68",
      ...
      params: [{ name: "bot_id", type: "long" }, { name: "scope", type: "string" }, {
        name: "public_key",
        type: "string"
      }],
      type: "account.AuthorizationForm"
      ...
      params: [{ name: "flags", type: "#" }, { name: "slug", type: "string" }, {
        name: "title",
        type: "string"
      }, { name: "document", type: "flags.2?InputDocument" }, { name: "settings", type: "flags.3?InputThemeSettings" }],
      type: "Theme"
    }, {
      id: 1555261397,
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "photo_id", type: "InputPhoto" }, {
        name: "reason",
        type: "ReportReason"
      }, { name: "message", type: "string" }],
      type: "Bool"
      ...
      params: [{ name: "flags", type: "#" }, { name: "correspondents", type: "flags.0?true" }, {
        ...
        name: "offset",
        type: "int"
      }, { name: "limit", type: "int" }, { name: "hash", type: "long" }],
      type: "contacts.TopPeers"
    }, {
      id: 451113900,
      ...
      params: [{ name: "flags", type: "#" }, { name: "delete_message", type: "flags.0?true" }, {
        name: "delete_history",
        type: "flags.1?true"
      }, { name: "report_spam", type: "flags.2?true" }, { name: "msg_id", type: "int" }],
      type: "Updates"
    }, {
      id: 1673946374,
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "offset_id", type: "int" }, {
        ...
        name: "max_id",
        type: "int"
      }, { name: "min_id", type: "int" }, { name: "hash", type: "long" }],
      type: "messages.Messages"
    }, {
      id: -1593989278,
      ...
      params: [{ name: "flags", type: "#" }, { name: "peer", type: "InputPeer" }, {
        name: "q",
        type: "string"
      }, { name: "from_id", type: "flags.0?InputPeer" }, { name: "top_msg_id", type: "flags.1?int" }, {
        name: "filter",
        type: "MessagesFilter"
      ...
      params: [{ name: "flags", type: "#" }, { name: "silent", type: "flags.5?true" }, {
        ...
        name: "reply_to_msg_id",
        type: "flags.0?int"
      }, { name: "media", type: "InputMedia" }, { name: "message", type: "string" }, {
        name: "random_id",
        type: "long"
      }, { name: "reply_markup", type: "flags.2?ReplyMarkup" }, {
        name: "entities",
      ...
      params: [{ name: "flags", type: "#" }, { name: "silent", type: "flags.5?true" }, {
        ...
        name: "drop_author",
        type: "flags.11?true"
      }, { name: "drop_media_captions", type: "flags.12?true" }, { name: "from_peer", type: "InputPeer" }, {
        name: "id",
        type: "Vector<int>"
      ...
      params: [{ name: "chat_id", type: "long" }, { name: "user_id", type: "InputUser" }, {
        name: "fwd_limit",
        type: "int"
      }],
      type: "Updates"
      ...
      params: [{ name: "flags", type: "#" }, { name: "revoke_history", type: "flags.0?true" }, {
        name: "chat_id",
        type: "long"
      ...
      params: [{ name: "flags", type: "#" }, { name: "delete_history", type: "flags.0?true" }, {
        name: "chat_id",
        type: "int"
      }],
      type: "Bool"
      ...
      params: [{ name: "flags", type: "#" }, { name: "silent", type: "flags.0?true" }, {
        name: "peer",
        type: "InputEncryptedChat"
      }, { name: "random_id", type: "long" }, { name: "data", type: "bytes" }],
      type: "messages.SentEncryptedMessage"
    }, {
      id: 1431914525,
      ...
      params: [{ name: "flags", type: "#" }, { name: "legacy_revoke_permanent", type: "flags.2?true" }, {
        name: "peer",
        type: "InputPeer"
      }, { name: "expire_date", type: "flags.0?int" }, { name: "usage_limit", type: "flags.1?int" }],
      type: "ExportedChatInvite"
    }, {
      id: 2106086025,
      method: "messages.exportChatInviteLayer84",
      params: [{ name: "chat_id", type: "int" }],
      type: "ExportedChatInvite"
    }, {
      id: 1051570619,
      ...
      id: 711765008,
      method: "messages.searchGlobalExt",
      params: [{ name: "flags", type: "#" }, { name: "q", type: "string" }, {
        name: "offset_date",
        type: "int"
      }, { name: "offset_peer", type: "InputPeer" }, { name: "offset_id", type: "int" }, {
        name: "limit",
        type: "int"
      }],
      type: "messages.Messages"
      ...
      params: [{ name: "user_id", type: "InputUser" }, { name: "max_id", type: "long" }, {
        name: "limit",
        type: "int"
      }],
      type: "messages.Chats"
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "limit", type: "int" }, { name: "hash", type: "long" }],
      type: "messages.Messages"
    }, {
      id: -872345397,
      ...
      params: [{ name: "flags", type: "#" }, { name: "silent", type: "flags.5?true" }, {
        ...
        name: "reply_to_msg_id",
        type: "flags.0?int"
      }, { name: "multi_media", type: "Vector<InputSingleMedia>" }, { name: "schedule_date", type: "flags.10?int" }],
      type: "Updates"
    }, {
      id: 1347929239,
      ...
      params: [{ name: "flags", type: "#" }, { name: "silent", type: "flags.0?true" }, {
        name: "unpin",
        type: "flags.1?true"
      }, { name: "pm_oneside", type: "flags.2?true" }, { name: "peer", type: "InputPeer" }, {
        name: "id",
        type: "int"
      }],
      type: "Updates"
      ...
      params: [{ name: "flags", type: "#" }, { name: "peer", type: "flags.1?InputPeer" }, {
        name: "msg_id",
        type: "flags.1?int"
      }, { name: "button_id", type: "flags.1?int" }, { name: "url", type: "flags.2?string" }],
      type: "UrlAuthResult"
    }, {
      id: -1322487515,
      ...
      }, { name: "msg_id", type: "flags.1?int" }, { name: "button_id", type: "flags.1?int" }, {
        name: "url",
        type: "flags.2?string"
      }],
      type: "UrlAuthResult"
      ...
      params: [{ name: "offset", type: "int" }, { name: "limit", type: "int" }, { name: "hash", type: "long" }],
      type: "messages.FeaturedStickers"
    }, {
      id: 584962828,
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "msg_id", type: "int" }, {
        name: "offset_id",
        type: "int"
      }, { name: "offset_date", type: "int" }, { name: "add_offset", type: "int" }, {
        name: "limit",
        type: "int"
      }, { name: "max_id", type: "int" }, { name: "min_id", type: "int" }, { name: "hash", type: "long" }],
      type: "messages.Messages"
    }, {
      id: 1147761405,
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "file", type: "InputFile" }, {
        name: "media_count",
        type: "int"
      }],
      type: "messages.HistoryImport"
      ...
      params: [{ name: "flags", type: "#" }, { name: "revoked", type: "flags.3?true" }, {
        name: "peer",
        type: "InputPeer"
      }, { name: "admin_id", type: "InputUser" }, { name: "offset_date", type: "flags.2?int" }, {
        name: "offset_link",
        type: "flags.2?string"
      }, { name: "limit", type: "int" }],
      type: "messages.ExportedChatInvites"
      ...
      params: [{ name: "flags", type: "#" }, { name: "revoked", type: "flags.2?true" }, {
        name: "peer",
        type: "InputPeer"
      }, { name: "link", type: "string" }, { name: "expire_date", type: "flags.0?int" }, {
        name: "usage_limit",
        type: "flags.1?int"
      }],
      type: "messages.ExportedChatInvite"
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "link", type: "string" }, {
        name: "offset_date",
        type: "int"
      }, { name: "offset_user", type: "InputUser" }, { name: "limit", type: "int" }],
      type: "messages.ChatInviteImporters"
    }, {
      id: -1207017500,
      ...
      params: [{ name: "peer", type: "InputPeer" }, { name: "emoticon", type: "string" }],
      type: "Updates"
    }, {
      id: 745510839,
      ...
      params: [{ name: "file_id", type: "long" }, { name: "file_part", type: "int" }, {
        name: "bytes",
        type: "bytes"
      }, { name: "flags", type: "#" }, { name: "peer", type: "flags.0?Peer" }, {
        name: "totalFileSize",
        type: "flags.1?long"
      }],
      type: "Bool"
      ...
      params: [{ name: "flags", type: "#" }, { name: "precise", type: "flags.0?true" }, {
        name: "cdn_supported",
        type: "flags.1?true"
      }, { name: "location", type: "InputFileLocation" }, { name: "offset", type: "int" }, {
        name: "limit",
        type: "int"
      }],
      type: "upload.File"
      ...
      params: [{ name: "file_id", type: "long" }, { name: "file_part", type: "int" }, {
        ...
        type: "int"
      }, { name: "bytes", type: "bytes" }, { name: "flags", type: "#" }, {
        name: "peer",
        type: "flags.0?Peer"
      }, { name: "totalFileSize", type: "flags.1?long" }],
      type: "Bool"
    }, {
      id: 619086221,
      ...
      params: [{ name: "channel", type: "InputChannel" }, {
        name: "filter",
        type: "ChannelParticipantsFilter"
      }, { name: "offset", type: "int" }, { name: "limit", type: "int" }, { name: "hash", type: "long" }],
      type: "channels.ChannelParticipants"
    }, {
      id: -1599378234,
      ...
      params: [{ name: "flags", type: "#" }, { name: "broadcast", type: "flags.0?true" }, {
        name: "megagroup",
        type: "flags.1?true"
      }, { name: "for_import", type: "flags.3?true" }, { name: "title", type: "string" }, {
        name: "about",
        type: "string"
      }, { name: "geo_point", type: "flags.2?InputGeoPoint" }, { name: "address", type: "flags.2?string" }],
      type: "Updates"
    }, {
      id: -751007486,
      ...
      id: 3344304261,
      method: "channels.inviteToChannelLayer84",
      params: [{ name: "channel", type: "InputChannel" }],
      type: "Updates"
    }, {
      id: -1072619549,
      ...
      params: [{ name: "flags", type: "#" }, { name: "grouped", type: "flags.0?true" }, {
        name: "thread",
        type: "flags.1?true"
      }, { name: "channel", type: "InputChannel" }, { name: "id", type: "int" }],
      type: "ExportedMessageLink"
    }, {
      id: 527021574,
      ...
      params: [{ name: "channel", type: "InputChannel" }, { name: "random_id", type: "bytes" }],
      type: "Bool"
    }, {
      id: -333377601,
      ...
      params: [{ name: "flags", type: "#" }, { name: "save", type: "flags.0?true" }, {
        name: "peer",
        type: "InputPeer"
      }, { name: "msg_id", type: "int" }, { name: "info", type: "PaymentRequestedInfo" }],
      type: "payments.ValidatedRequestedInfo"
    }, {
      id: 818134173,
      method: "payments.sendPaymentForm",
      params: [{ name: "flags", type: "#" }, { name: "form_id", type: "long" }, {
        name: "peer",
        type: "InputPeer"
      ...
      params: [{ name: "flags", type: "#" }, { name: "video", type: "flags.0?true" }, {
        name: "peer",
        type: "InputPhoneCall"
      }, { name: "duration", type: "int" }, { name: "reason", type: "PhoneCallDiscardReason" }, {
        name: "connection_id",
        type: "long"
      }],
      type: "Updates"
      ...
      params: [{ name: "flags", type: "#" }, { name: "peer", type: "InputPeer" }, {
        name: "random_id",
        type: "int"
      }, { name: "title", type: "flags.0?string" }, { name: "schedule_date", type: "flags.1?int" }],
      type: "Updates"
    }, {
      id: -1322057861,
      ...
      params: [{ name: "flags", type: "#" }, { name: "muted", type: "flags.0?true" }, {
        name: "video_stopped",
        type: "flags.2?true"
      }, { name: "call", type: "InputGroupCall" }, { name: "join_as", type: "InputPeer" }, {
        name: "invite_hash",
        type: "flags.1?string"
      ...
      params: [{ name: "flags", type: "#" }, { name: "reset_invite_hash", type: "flags.1?true" }, {
        name: "call",
        type: "InputGroupCall"
      ...
      params: [{ name: "call", type: "InputGroupCall" }, { name: "ids", type: "Vector<InputPeer>" }, {
        name: "sources",
        type: "Vector<int>"
      }, { name: "offset", type: "string" }, { name: "limit", type: "int" }],
      type: "phone.GroupParticipants"
    }, {
      id: -1248003721,
      ...
      params: [{ name: "flags", type: "#" }, { name: "start", type: "flags.0?true" }, {
        name: "video",
        type: "flags.2?true"
      }, { name: "call", type: "InputGroupCall" }, { name: "title", type: "flags.1?string" }, {
        name: "video_portrait",
        type: "flags.2?Bool"
      }],
      type: "Updates"
      ...
      params: [{ name: "flags", type: "#" }, { name: "call", type: "InputGroupCall" }, {
        name: "participant",
        type: "InputPeer"
      }, { name: "muted", type: "flags.0?Bool" }, { name: "volume", type: "flags.1?int" }, {
        name: "raise_hand",
        type: "flags.2?Bool"
      ...
      params: [{ name: "flags", type: "#" }, { name: "can_self_unmute", type: "flags.0?true" }, {
        name: "call",
        type: "InputGroupCall"
      }],
      type: "phone.ExportedGroupCallInvite"
      ...
      params: [{ name: "flags", type: "#" }, { name: "token", type: "string" }, { name: "x", type: "flags.0?long" }],
      type: "StatsGraph"
    }, {
      id: -589330937,
      ...
      id: -599448727,
      method: "eitaaRefreshToken",
      params: [{ name: "app_info", type: "EitaaAppInfo" }],
      type: "EitaaRefreshToken"
    }, {
      id: 1640969877,
      method: "liveGetMedia",
      params: [{ name: "flags", type: "#" }, { name: "id", type: "long" }, { name: "access_hash", type: "long" }],
      type: "LiveGetMedia"
    }, {
      id: 950734118,
      method: "adsGetAdsPack",
      params: [{ name: "flags", type: "int" }, { name: "location", type: "AdsLocation" }],
      type: "AdsGetAdsPack"
    }, {
      id: -1626620176,
      method: "statAd",
      ...
      id: -1261786457,
      method: "statReportAdActionPerformed",
      params: [{ name: "statAd", type: "StatAd" }],
      type: "StatReportAdActionPerformed"
    },{
      id: -1311039949,
      method: "sendTwoStepVerificationCode",
      params: [],
      type: "auth.SentCode"
  }, {
      id: 1470999061,
      method: "verifyTwoStepVerificationCode",
      params: [{
          name: "phone_code_hash",
          type: "string"
      }, {
    ...
    id: -1131605573,
    method: "account.getPasswordSettings68",
    params: [{
        name: "password_hash",
        type: "bytes"
    }],
